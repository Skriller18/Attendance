    ...
    def run_recognition(self):
        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                # Improve frame quality using a median filter
                median = cv2.medianBlur(small_frame, 5)

                # Improve frame quality using bilateral filtering
                bilateral = cv2.bilateralFilter(median, 9, 75, 75)

                self.face_locations = face_recognition.face_locations(bilateral)
                self.face_encodings = face_recognition.face_encodings(bilateral, self.face_locations)
